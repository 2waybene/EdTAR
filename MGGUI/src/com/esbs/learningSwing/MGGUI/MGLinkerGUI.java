...
//       are listed on the top part of the interface, with specific functions
//       listed as following:
...
//
//Limitation: Currently, most programs are invoked in a default directory.
...
public void ExecProgram (String commandLine){
 ...
 newLine + "Make sure run SAS_result first, then invoke macro with correct "+
  ...
  //	fc.addChoosableFileFilter(new textFileFilter());
	// May need a new class like the following
	//  fc.addChoosableFileFilter(new textFileFilter());
